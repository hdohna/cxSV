...
FitSelectionModels_pracma <- function(PredictMat,  Freqs, 
  ...
  # Get maximum likelihood estimate for effect of the first predictor variable 
  # on selection
  ...
  # Get maximum likelihood estimate for effect of the second predictor variable 
  # on selection
  ...
  # Get maximum likelihood estimate for effect of the first and second predictor 
