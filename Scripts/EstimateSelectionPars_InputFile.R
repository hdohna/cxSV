...
# variants (cxSV) and normal structural variants (SV) where the parameters
# are specified in an input file

# Collect arguments and extract path to input file as first argument: p
...
# Load the input file that contains population size, SVPath, Cols2Include,
# and ThetaStart
